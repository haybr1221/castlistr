...
function ConfirmDeleteList({ onConfirm, onClose }) {
    return (
        <div className="modal" id="delete-conf">
            ...
            <form onSubmit={onConfirm}>
                <div id="button-box">
                    <button id="delete-yes" type="submit" name="yes" onClick={onConfirm}>
                        Yes
                    </button>
                    <button type="submit" name="no" className="button" onClick={onClose} id="delete-no">
                        No
                    </button>
                </div>
            </form>
